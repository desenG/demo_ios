...
- (void)defalutInit
{
    ...
    _titleView.backgroundColor = [ResourceHelper getUIColorFromHex:BLUEPRIMARY];
...
- (void)bottomIn
{
    ...
    self.frame=CGRectMake(self.frame.origin.x,keywindow.bounds.size.height,self.frame.size.width,self.frame.size.height);
