...
- (instancetype)init {
    if ((self = [super initWithFrame:CGRectMake(0, 0, Size_x, Size_y)])) {
        ...
        y = y - 100; //Offset so the helmet is half way not including the bubbles'
        CGPoint myPoint = CGPointMake(x,y);
        [self setCenter: myPoint];
        [self setClipsToBounds:NO];
        
        //[self.layer setBackgroundColor:[[UIColor colorWithRed:218.0/255.0 green:238.0/255.0 blue:252.0/255.0 alpha:0.5] CGColor]];//[UIColor colorWithWhite:0 alpha:0.5]
        //[self.layer setCornerRadius:10];
        //[self.layer setBorderWidth:2.0];
        //[self.layer setBorderColor:[[UIColor colorWithRed:255.0/255.0 green:255.0/255.0 blue:255.0/255.0 alpha:0.5] CGColor]];
        ...
        [self.imageView setImage:[UIImage animatedImageWithAnimatedGIFURL:[[NSBundle mainBundle] URLForResource:@"loading200.gif" withExtension:nil]]];
